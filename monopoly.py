...
def runSimulation(args):
    ...
    for i in range(0, args.number):
        ...
        g = Game([Player()] * args.players, args.rounds)
        g.run()
    ...
    r.write(args.number, args.rounds)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Programm to simulate the game\
		of Monopoly.")
    parser.add_argument("-n", "--number", type=positiveInt, default=1000000,
